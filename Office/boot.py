...
# Backup files
f = open('log.txt', 'w')
f.write("{\"row\" : \"0\", \"pos\" : \"0\", \"TempMin\" : \"" + str(tempLimit) + "\"}")
f.write("{\"row\" : \"0\", \"pos\" : \"1\", \"TempMax\" : \"" + str(tMax) + "\"}")
f.write("{\"row\" : \"0\", \"pos\" : \"2\", \"HumidMin\" : \"" + str(humidLimit) + "\"}")
f.write("{\"row\" : \"0\", \"pos\" : \"3\", \"HumidMax\" : \"" + str(hMax) + "\"}")
